        ...
        <div className='w-full'>
            <div className='lg:w-[1200px] mx-auto'>
                ...
                <div className='lg:flex md:flex'>
                    <div className='lg:w-[400px] lg:h-[450px] bg-[#ede6d6] lg:py-[60px] lg:pl-10 md:pl-0 pl-10 box-border md:basis-1/3 md:h-80 h-80'>
                    ...
                    <div className='lg:w-[400px] lg:h-[450px] md:h-auto h-96 relative membership md:basis-1/3'>
                        <span className='lg:w-[400px] lg:h-[97px] w-full bg-white lg:p-[30px] p-5 box-border flex justify-between items-center text-[#c30f30] font-bold absolute bottom-0'>
                            <p>NEW 공차 멤버십 안내</p>
                            <NavLink href='/' className='text-[13px] text-[#777] underline'>자세히 보기　&gt;</NavLink>
                        </span>
                    </div>
                    <div className='lg:w-[400px] lg:h-[450px] md:h-auto h-96 newopen relative md:basis-1/3'>
                        <span className='lg:w-[400px] lg:h-[97px] w-full bg-white flex lg:p-[30px] p-5 box-border justify-between items-center text-[#c30f30] font-bold absolute bottom-0'>
                            <p>오픈 매장 안내</p>
                            <NavLink href='/' className='text-[13px] text-[#777] underline'>자세히 보기　&gt;</NavLink>
                        </span>
                    </div>
            ...
            <div className='w-full lg:h-[471px] bg-[#f5eee8]'>
                <ul className='flex py-[60px] lg:px-[400px] px-10 justify-between lg:text-[15px] text-sm items-center'>
                    <li className='lg:pr-[650px] pr-10'><h2 className='font-bold lg:text-2xl md:text-xl text-lg'>공차 티 레시피</h2></li>
                ...
                <div className='lg:flex lg:px-[400px]'>
                    <img src="./../../img/brand_main_recipe_img1.jpg" alt="tea" className='lg:w-[600px] lg:h-[255px]' />
                    <ul className='leading-[50px] text-[15px] text-[#444]'>
                        <li><h1 className='font-bold lg:text-4xl md:text-2xl text-xl mb-[15px]'>TEA RECIPE - 티 레시피</h1></li>
